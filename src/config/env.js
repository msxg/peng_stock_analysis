...
export const env = {
  ...
  STOCK_INTRADAY_MOOTDX_ENABLED: process.env.STOCK_INTRADAY_MOOTDX_ENABLED || 'false',
  STOCK_INTRADAY_MOOTDX_PYTHON_BIN: process.env.STOCK_INTRADAY_MOOTDX_PYTHON_BIN || 'python3',
  STOCK_INTRADAY_MOOTDX_TIMEOUT_MS: Number(process.env.STOCK_INTRADAY_MOOTDX_TIMEOUT_MS || 4500),
